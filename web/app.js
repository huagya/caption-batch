(() => {
  ...
  function jobBody() {
    ...
    const body = {
      ...
      user_prompt: (userPromptEl && userPromptEl.value != null) ? userPromptEl.value : "",
  ...
  function applySettings(s, dflt) {
    ...
    if (userPromptEl && s.user_prompt != null) userPromptEl.value = s.user_prompt;
  ...
  (async () => {
    try {
      ...
      if (userPromptEl && d.user_prompt != null) userPromptEl.value = d.user_prompt;
